...
# Phase 2: U-Net v2 E2E (BiSeNet + balanced attack/quality — Run 4)
echo ""
echo "=== Phase 2a: U-Net V2 E2E (Run 4) ==="
python scripts/train_encoder.py --phase v2_e2e \
    ...
    --batch-size 2 --eot-samples 3 --epsilon 0.0627 \
    --alpha-arcface 10.0 --beta-clip 5.0 \
    --lambda-lpips 0.5 --lambda-reg 0.001 \
    --mask-floor 0.0 --bisenet-weights ./weights/bisenet_face.pth
...
# Phase 4: ViT v2 E2E (BiSeNet + balanced attack/quality — Run 4)
echo ""
echo "=== Phase 2b: ViT V2 E2E (Run 4) ==="
python scripts/train_encoder.py --phase v2_e2e \
